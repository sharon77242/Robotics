...
bool WaypointManager::IsPathClear(Node * firstNode, Node * secondNode)
{
	...
	int xFirst = firstNode->GetLocationInMap()->X();
	int xSecond = secondNode->GetLocationInMap()->X();
	int yFirst = firstNode->GetLocationInMap()->Y();
	int ySecond = secondNode->GetLocationInMap()->Y();
